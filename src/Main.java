...
//        Ведите количество желаемого товара = 2
//        1 - показать все товары
//        2 - добавить в корзину
//        3 - показать корзину покупок
//        6 - купить (оформить заказ)
...
//        Ваш выбор =  2
//        Выбрано 2 - соверишть покупку
//        Выберите товар для покупки, ввыедите назавние  = Сувенир
//        Количество товара Сувенир в магазине 3
//        Ведите количество желаемого товара = 1
//        1 - показать все товары
//        2 - добавить в корзину
//        3 - показать корзину покупок
//        6 - купить (оформить заказ)
...
//        1500.0
//        1
//        Количество товаров в корзине = 1.0
//        1 - показать все товары
//        2 - добавить в корзину
//        3 - показать корзину покупок
//        6 - купить (оформить заказ)
...
//        Выбрано 6 - купить (оформить заказ)
//        Покупка товара
//        Передано в статистику:1500.0
//        Передано в статистику количество:1
//        1 - показать все товары
//        2 - добавить в корзину
//        3 - показать корзину покупок
//        6 - купить (оформить заказ)
...
//        Ваш выбор =  2
//        Выбрано 2 - соверишть покупку
//        Выберите товар для покупки, ввыедите назавние  = Новый Сувенир
//        Количество товара Новый Сувенир в магазине 10
//        Ведите количество желаемого товара = 1
//        1 - показать все товары
//        2 - добавить в корзину
//        3 - показать корзину покупок
